...
<main class="container main-content">
  ...
  <?php if(currentUser() && currentUser()['id'] !== $pilote['id']): ?>
  <a href="<?= SITE_URL ?>/messages.php?with=<?= (int)$pilote['id'] ?>&name=<?= urlencode($pilote['prenom'].' '.$pilote['nom']) ?>&role=pilote"
     class="btn btn-ghost" style="font-size:.82rem">💬 Envoyer un message</a>
  <?php endif; ?>
</div>
